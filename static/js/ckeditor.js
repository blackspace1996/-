...
!function (t) {
	t.en = Object.assign(t.en || {}, {
		...
		p: "Enter image caption",
		q: "media widget",
		r: "Insert image",
		s: "Insert media",
		t: "The URL must not be empty.",
		u: "This media URL is not supported.",
		v: "Upload failed",
		w: "Link",
		x: "Insert table",
		y: "Header column",
		z: "Insert column left",
		aa: "Insert column right",
		ab: "Delete column",
		ac: "Column",
		ad: "Header row",
		ae: "Insert row below",
		...
		ak: "Merge cell down",
		al: "Merge cell left",
		am: "Split cell vertically",
		an: "Split cell horizontally",
		ao: "Merge cells",
		ap: "Numbered List",
		aq: "Bulleted List",
		ar: "Align left",
		...
		bv: "Undo",
		bw: "Redo",
		bx: "Open in a new tab",
		by: "Downloadable",
		bz: "Unlink",
		ca: "Edit link",
		cb: "Open link in new tab",
		cc: "This link has no URL",
		cd: "Link URL",
		ce: "Paste the media URL in the input.",
		cf: "Tip: Paste the URL into the content to embed faster.",
		cg: "Media URL"
	})
	...
	return function (t) {
		...
		var Ne = function (t) {
			...
			Ve = K(st), ze = K(Re), Be = K(De), Fe = K(Le), Ue = m;
		(Oe && "[object DataView]" != Ue(new Oe(new ArrayBuffer(1))) || st && "[object Map]" != Ue(new st) || Re && "[object Promise]" != Ue(Re.resolve()) || De && "[object Set]" != Ue(new De) || Le && "[object WeakMap]" != Ue(new Le)) && (Ue = function (t) {
			var e = m(t), n = "[object Object]" == e ? t.constructor : void 0, i = n ? K(n) : "";
			if (i) switch (i) {
				case je:
		...
		var tn = function (t, e) {
			...
			fn = "[object Float64Array]", gn = "[object Int8Array]", mn = "[object Int16Array]",
		...
		pr.prototype.add = pr.prototype.push = gr, pr.prototype.has = mr;
		var br = pr;
		var wr = function (t, e) {
		...
		var Qr = function (t, e, n, i, o, r) {
			...
			if (!(n & qr)) {
				var f = d && Gr.call(t, "__wrapped__"), g = h && Gr.call(e, "__wrapped__");
				if (f || g) {
		...
		}, us = "Expected a function", fs = Math.max, gs = Math.min;
					...
					return e => {
						e.on("addMarker:" + t.model, function (t) {
							return (e, n, i) => {
								...
								if (!o) return;
								if (!i.consumable.consume(n.item, e.name)) return;
								const r = ga(o), s = i.writer, a = s.document.selection;
							...
							return (e, n, i) => {
								...
								const o = wa(t, n, i);
								if (!o) return;
								const r = ga(o), s = i.mapper.markerNameToElements(n.markerName);
								if (s) {
		...
		class mc extends Ja {
			...
			getReversed() {
				...
				return new gc(this.moveTargetPosition, this.howMany, this.splitPosition, e, this.baseVersion + 1)
			}
		...
		class bc {
			...
			_merge(t) {
				const e = $s._createAt(t.nodeBefore, "end"), n = $s._createAt(t.nodeAfter, 0),
					...
					s = new gc(n, t.nodeAfter.maxOffset, e, o, r);
		...
		const md = [wo("arrowUp"), wo("arrowRight"), wo("arrowDown"), wo("arrowLeft"), 9, 16, 17, 18, 19, 20, 27, 33, 34, 35, 36, 45, 91, 93, 144, 145, 173, 174, 175, 176, 177, 178, 179, 255];
		for (let t = 112; t <= 135; t++) md.push(t);
		...
		class wd {
			...
			_handleContainerChildrenMutations(t, e) {
				...
				if (f === u) return;
				const g = Qo(f, u), {firstChangeAt: m, insertions: p, deletions: b} = _d(g);
				let w = null;
		...
		class vd extends Kl {
			...
			init() {
				...
				t.commands.add("input", e), gd(t), function (t) {
		...
		Sd(ac, ac, (t, e, n) => {
			...
			if (!t.graveyardPosition && !n.bWasUndone && t.splitPosition.hasSameParentAs(e.sourcePosition)) {
				...
				const i = new $s(e.graveyardPosition.root, n),
					o = mc.getInsertionPosition(new $s(e.graveyardPosition.root, n)), r = new mc(i, 0, null, 0);
			...
			_updatePendingAction() {
				...
				if (this.loaders.length) {
					if (!this._pendingAction) {
						const e = this.editor.t, n = t => `${e("ax")} ${parseInt(t)}%.`;
		...
		class rh {
			...
			_sendRequest(t) {
                ...
                e.append("upload", t), e.append("csrfmiddlewaretoken", csrftoken), this.xhr.send(e)
			}
		}
		...
		class mh extends Kl {
			init() {
				...
				t.ui.componentFactory.add(gh, n => {
					const i = t.commands.get(gh), o = new Wd(n);
					return o.set({
						label: e("f"),
						icon: fh,
						keystroke: "CTRL+B",
		...
		function Xh(t, e, n = {}) {
			return go.isEdge || e.setAttribute("contenteditable", "false", t), e.addClass(Kh, t), e.setCustomProperty("widget", !0, t), t.getFillerOffset = iu, n.label && function (t, e, n) {
			...
			init() {
				...
				this._previouslySelected = new Set, this.editor.editing.downcastDispatcher.on("selection", (t, e, n) => {
					...
					for (const t of o.getRanges()) for (const e of t) {
						const t = e.item;
						Zh(t) && !gu(t, s) && (i.addClass(Jh, t), this._previouslySelected.add(t), s = t, t == r && i.setSelection(o.getRanges(), {
							fake: !0,
							label: tu(r)
						}))
					}
		...
		class pu extends Kl {
			init() {
				this.editor.commands.add("imageTextAlternative", new mu(this.editor))
			}
		}
		...
		class uf extends Kl {
			...
			init() {
				...
				t.commands.add("paragraph", new df(t)), e.schema.register("paragraph", {inheritAllFrom: "$block"}), t.conversion.elementToElement({
					...
					n.consumable.test(e.viewItem, {name: e.viewItem.name}) && gf(e.viewItem, e.modelCursor, n.schema) && Object.assign(e, ff(e.viewItem, e.modelCursor, n))
				}, {priority: "low"}), n.upcastDispatcher.on("text", (t, e, n) => {
					e.modelRange || gf(e.viewItem, e.modelCursor, n.schema) && Object.assign(e, ff(e.viewItem, e.modelCursor, n))
		...
		class wf extends Kl {
			...
			init() {
				...
				this._addDefaultH1Conversion(t), t.commands.add("heading", new mf(t, n))
			}
		...
		class Kf extends Kl {
			...
			register(t, {ariaLabel: e, items: n, getRelatedElement: i, balloonClassName: o = "ck-toolbar-container"}) {
				...
				if (a.ariaLabel = e || s("ay"), this._toolbarDefinitions.has(t)) throw new Gn.b("widget-toolbar-duplicated: Toolbar with the given id was already added.", this, {toolbarId: t});
		...
		function Xf(t, e, n) {
			return n.createRange(tg(t, e, !0, n), tg(t, e, !1, n))
		}
		...
		var og = function (t, e, n) {
			var i = t.length;
			return n = void 0 === n ? i : n, !e && n >= i ? t : ig(t, e, n)
		}, rg = RegExp("[\\u200d\\ud800-\\udfff\\u0300-\\u036f\\ufe20-\\ufe2f\\u20d0-\\u20ff\\ufe0e\\ufe0f]");
		var sg = function (t) {
			return rg.test(t)
		};
		var ag = function (t) {
			...
			dg = "\\ud83c[\\udffb-\\udfff]", hg = "[^\\ud800-\\udfff]", ug = "(?:\\ud83c[\\udde6-\\uddff]){2}",
			fg = "[\\ud800-\\udbff][\\udc00-\\udfff]", gg = "(?:" + lg + "|" + dg + ")" + "?",
			mg = "[\\ufe0e\\ufe0f]?" + gg + ("(?:\\u200d(?:" + [hg, ug, fg].join("|") + ")[\\ufe0e\\ufe0f]?" + gg + ")*"),
			pg = "(?:" + [hg + lg + "?", lg, ug, fg, cg].join("|") + ")",
			bg = RegExp(dg + "(?=" + dg + ")|" + pg + mg, "g");
		var wg = function (t) {
			return t.match(bg) || []
		};
		var kg = function (t) {
			return sg(t) ? wg(t) : ag(t)
		};
		var _g = function (t, e) {
			for (var n = -1, i = null == t ? 0 : t.length, o = Array(i); ++n < i;) o[n] = e(t[n], n, t);
			return o
		}, vg = 1 / 0, yg = o ? o.prototype : void 0, xg = yg ? yg.toString : void 0;
		var Ag = function t(e) {
			if ("string" == typeof e) return e;
			if (Wt(e)) return _g(e, t) + "";
			if (os(e)) return xg ? xg.call(e) : "";
			var n = e + "";
			return "0" == n && 1 / e == -vg ? "-0" : n
		};
		var Tg = function (t) {
			return null == t ? "" : Ag(t)
		};
		var Cg = function (t) {
			return function (e) {
				e = Tg(e);
				var n = sg(e) ? kg(e) : void 0, i = n ? n[0] : e.charAt(0), o = n ? og(n, 1).join("") : e.slice(1);
				return i[t]() + o
			}
		}("toUpperCase");
		const Pg = /[\u0000-\u0020\u00A0\u1680\u180E\u2000-\u2029\u205f\u3000]/g,
			Sg = /^(?:(?:https?|ftps?|mailto):|[^a-z]|[a-z+.-]+(?:[^a-z+.:-]|$))/i;
		...
		class Og {
			constructor(t, e, n) {
				this.model = t, this.attribute = n, this._modelSelection = t.document.selection, this._overrideUid = null, this._isNextGravityRestorationSkipped = !1, e.listenTo(this._modelSelection, "change:range", (t, e) => {
					this._isNextGravityRestorationSkipped ? this._isNextGravityRestorationSkipped = !1 : this._isGravityOverridden && (!e.directChange && Rg(this._modelSelection.getFirstPosition(), n) || this._restoreGravity())
				})
			}

			handleForwardMovement(t, e) {
				const n = this.attribute;
				if (!(this._isGravityOverridden || t.isAtStart && this._hasSelectionAttribute)) return jg(t, n) && this._hasSelectionAttribute ? (this._preventCaretMovement(e), this._removeSelectionAttribute(), !0) : Dg(t, n) ? (this._preventCaretMovement(e), this._overrideGravity(), !0) : Lg(t, n) && this._hasSelectionAttribute ? (this._preventCaretMovement(e), this._overrideGravity(), !0) : void 0
			}

			handleBackwardMovement(t, e) {
				const n = this.attribute;
				return this._isGravityOverridden ? jg(t, n) && this._hasSelectionAttribute ? (this._preventCaretMovement(e), this._restoreGravity(), this._removeSelectionAttribute(), !0) : (this._preventCaretMovement(e), this._restoreGravity(), t.isAtStart && this._removeSelectionAttribute(), !0) : jg(t, n) && !this._hasSelectionAttribute ? (this._preventCaretMovement(e), this._setSelectionAttributeFromTheNodeBefore(t), !0) : t.isAtEnd && Lg(t, n) ? this._hasSelectionAttribute ? void (Vg(t, n) && (this._skipNextAutomaticGravityRestoration(), this._overrideGravity())) : (this._preventCaretMovement(e), this._setSelectionAttributeFromTheNodeBefore(t), !0) : t.isAtStart ? this._hasSelectionAttribute ? (this._removeSelectionAttribute(), this._preventCaretMovement(e), !0) : void 0 : void (Vg(t, n) && (this._skipNextAutomaticGravityRestoration(), this._overrideGravity()))
			}
		...
		function Vg(t, e) {
			return Rg(t.getShiftedBy(-1), e)
		}

		n(73);
		const zg = "ck-link_selected", Bg = "automatic", Fg = "manual", Ug = /^(https?:)?\/\//;
		...
		class Hg extends Kl {
			...
			init() {
				...
				}), t.commands.add("link", new eg(t)), t.commands.add("unlink", new ng(t));
				const n = function (t, e) {
					const n = {"Open in a new tab": t("bx"), Downloadable: t("by")};
					return e.forEach(t => (t.label && n[t.label] && (t.label = n[t.label]), t)), e
				}(t.t, function (t) {
					const e = [];
					if (t) for (const [n, i]of Object.entries(t)) {
						const t = Object.assign({}, i, {id: `link${Cg(n)}`});
						e.push(t)
					}
					return e
				}(t.config.get("link.decorators")));
				this._enableAutomaticDecorators(n.filter(t => t.mode === Bg)), this._enableManualDecorators(n.filter(t => t.mode === Fg)), function ({view: t, model: e, emitter: n, attribute: i, locale: o}) {
					const r = new Og(e, n, i), s = e.document.selection;
			...
			_enableAutomaticDecorators(t) {
				const e = this.editor, n = new Ig;
				e.config.get("link.addTargetToExternalLinks") && n.add({
					id: "linkIsExternal",
					mode: Bg,
					callback: t => Ug.test(t),
			...
			_enableManualDecorators(t) {
				...
				t.forEach(t => {
					e.model.schema.extend("$text", {allowAttributes: t.id}), n.add(new Ng(t)), e.conversion.for("downcast").attributeToElement({
						model: t.id,
						view: (e, i) => {
							if (e) {
			...
			_setupLinkHighlight() {
				...
				e.document.registerPostFixer(e => {
					...
					if (i.hasAttribute("linkHref")) {
						...
						for (const t of s.getItems()) t.is("a") && !t.hasClass(zg) && (e.addClass(zg, t), n.add(t), o = !0)
					}
					return o
				}), t.conversion.for("editingDowncast").add(t => {
					function i() {
						e.change(t => {
							for (const e of n.values()) t.removeClass(zg, e), n.delete(e)
						})
					}
		...
		class Wg extends Dl {
			...
			_createUrlInput() {
				const t = this.locale.t, e = new wu(this.locale, ku);
				return e.label = t("cd"), e.inputView.placeholder = "https://example.com", e
			}
		...
		var Yg = '<svg viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M11.077 15l.991-1.416a.75.75 0 1 1 1.229.86l-1.148 1.64a.748.748 0 0 1-.217.206 5.251 5.251 0 0 1-8.503-5.955.741.741 0 0 1 .12-.274l1.147-1.639a.75.75 0 1 1 1.228.86L4.933 10.7l.006.003a3.75 3.75 0 0 0 6.132 4.294l.006.004zm5.494-5.335a.748.748 0 0 1-.12.274l-1.147 1.639a.75.75 0 1 1-1.228-.86l.86-1.23a3.75 3.75 0 0 0-6.144-4.301l-.86 1.229a.75.75 0 0 1-1.229-.86l1.148-1.64a.748.748 0 0 1 .217-.206 5.251 5.251 0 0 1 8.503 5.955zm-4.563-2.532a.75.75 0 0 1 .184 1.045l-3.155 4.505a.75.75 0 1 1-1.229-.86l3.155-4.506a.75.75 0 0 1 1.045-.184zm4.919 10.562l-1.414 1.414a.75.75 0 1 1-1.06-1.06l1.414-1.415-1.415-1.414a.75.75 0 0 1 1.061-1.06l1.414 1.414 1.414-1.415a.75.75 0 0 1 1.061 1.061l-1.414 1.414 1.414 1.415a.75.75 0 0 1-1.06 1.06l-1.415-1.414z"/></svg>',
			$g = '<svg viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M7.3 17.37l-.061.088a1.518 1.518 0 0 1-.934.535l-4.178.663-.806-4.153a1.495 1.495 0 0 1 .187-1.058l.056-.086L8.77 2.639c.958-1.351 2.803-1.076 4.296-.03 1.497 1.047 2.387 2.693 1.433 4.055L7.3 17.37zM9.14 4.728l-5.545 8.346 3.277 2.294 5.544-8.346L9.14 4.728zM6.07 16.512l-3.276-2.295.53 2.73 2.746-.435zM9.994 3.506L13.271 5.8c.316-.452-.16-1.333-1.065-1.966-.905-.634-1.895-.78-2.212-.328zM8 18.5L9.375 17H19v1.5H8z"/></svg>';
		n(77);
		...
		class Gg extends Dl {
			constructor(t) {
				super(t);
				const e = t.t;
				this.focusTracker = new sl, this.keystrokes = new Jc, this.previewButtonView = this._createPreviewButton(), this.unlinkButtonView = this._createButton(e("bz"), Yg, "unlink"), this.editButtonView = this._createButton(e("ca"), $g, "edit"), this.set("href"), this._focusables = new ml, this._focusCycler = new ql({
					focusables: this._focusables,
					focusTracker: this.focusTracker,
					keystrokeHandler: this.keystrokes,
					actions: {focusPrevious: "shift + tab", focusNext: "tab"}
			...
			_createPreviewButton() {
				...
				return t.set({
					...
					attributes: {
						...
						href: e.to("href", t => t && Eg(t)),
						target: "_blank"
					}
				}), t.bind("label").to(this, "href", t => t || n("cc")), t.bind("isEnabled").to(this, "href", t => !!t), t.template.tag = "a", t.template.eventListeners = {}, t
			}
		}
		...
		class Jg extends Kl {
			...
			init() {
				const t = this.editor;
				t.editing.view.addObserver(qg), this.actionsView = this._createActionsView(), this.formView = this._createFormView(), this._balloon = t.plugins.get(Lu), this._createToolbarLinkButton(), this._enableUserBalloonInteractions()
			}
			...
			_createActionsView() {
				const t = this.editor, e = new Gg(t.locale), n = t.commands.get("link"), i = t.commands.get("unlink");
				return e.bind("href").to(n, "value"), e.editButtonView.bind("isEnabled").to(n), e.unlinkButtonView.bind("isEnabled").to(i), this.listenTo(e, "edit", () => {
					...
					this._hideUI(), e()
				}), e.keystrokes.set(Kg, (t, e) => {
					this._addFormView(), e()
				}), e
			}

			_createFormView() {
				const t = this.editor, e = t.commands.get("link"), n = new Wg(t.locale, e.manualDecorators);
			...
			_createToolbarLinkButton() {
				...
				t.keystrokes.set(Kg, (t, n) => {
					n(), e.isEnabled && this._showUI(!0)
				}), t.ui.componentFactory.add("link", t => {
					const i = new Wd(t);
					return i.isEnabled = !0, i.label = n("w"), i.icon = Qg, i.keystroke = Kg, i.tooltip = !0, i.isToggleable = !0, i.bind("isEnabled").to(e, "isEnabled"), i.bind("isOn").to(e, "value", t => !!t), this.listenTo(i, "execute", () => this._showUI(!0)), i
				})
			}
			...
			_getSelectedLinkElement() {
				...
				if (e.isCollapsed) return Zg(e.getFirstPosition());
				{
					const n = e.getFirstRange().getTrimmed(), i = Zg(n.start), o = Zg(n.end);
		...
		class Xg extends ed {
			...
			execute() {
				const t = this.editor.model, e = t.document,
					n = Array.from(e.selection.getSelectedBlocks()).filter(e => em(e, t.schema)), i = !0 === this.value;
				t.change(t => {
					if (i) {
		...
		function om(t, e, n, i) {
			...
			if (a = sm(a), s.insert(a, o), l && "listItem" == l.name) {
				...
				for (const t of n) if (t.item.is("li")) {
					...
					rm(s, r.nodeBefore, r.nodeAfter), s.move(s.createRangeOn(o), r), n.position = i
				}
			} else {
			...
			rm(s, o, o.nextSibling), rm(s, o.previousSibling, o)
		}
		...
		function um(t, e, n) {
			...
			rm(o, i, i.nextSibling), rm(o, i.previousSibling, i);
				...
				if (o.length > 0) {
					for (let e = 0; e < o.length; e++) {
						...
						if (t = i.insert(t, o[e]).end, e > 0) {
							const e = rm(i, n, n.nextSibling);
							e && e.parent == n && t.offset--
						}
					}
					rm(i, t.nodeBefore, t.nodeAfter)
				}
			}
		}
			...
			if (n.consumable.consume(e.viewItem, {name: !0})) {
				...
				const a = function (t, e, n) {
					...
					for (const s of e) if ("ul" == s.name || "ol" == s.name) r = n.convertItem(s, r).modelCursor; else {
						...
						c && (t = e.modelCursor.parent.is("listItem") ? e.modelCursor.parent : _m(e.modelCursor), r = i.createPositionAfter(t))
					}
					return r
		...
		function vm(t, e, n, i, o, r) {
			const s = am(e.nodeBefore, {sameIndent: !0, smallerIndent: !0, listIndent: t, foo: "b"}), a = o.mapper,
			...
			d = sm(d);
			for (const t of[...i.getChildren()]) (t.is("ul") || t.is("ol")) && (d = c.move(c.createRangeOn(t), d).end, rm(c, t, t.nextSibling), rm(c, t.previousSibling, t))
		}
		...
		class ym extends Kl {
			...
			init() {
				...
				t.model.document.registerPostFixer(e => (function (t, e) {
				...
				})(t.model, e)), n.mapper.registerViewToModelLength("li", xm), e.mapper.registerViewToModelLength("li", xm), n.mapper.on("modelToViewPosition", wm(n.view)), n.mapper.on("viewToModelPosition", function (t) {
					return (e, n) => {
					...
					return (e, n, i) => {
						...
						r.remove(c), a && a.nextSibling && rm(r, a, a.nextSibling), vm(n.attributeOldValue + 1, n.range.start, c.start, o, i, t), om(n.item, o, i, t);
					...
					return (e, n, i) => {
						...
						a && a.nextSibling && rm(r, a, a.nextSibling), vm(i.mapper.toModelElement(o).getAttribute("listIndent") + 1, n.position, c.start, o, i, t);
						for (const t of r.createRangeIn(l).getItems()) i.mapper.unbindViewElement(t);
						e.stop()
					}
				}(t.model)), n.downcastDispatcher.on("remove", gm, {priority: "low"}), e.upcastDispatcher.on("element:ul", pm, {priority: "high"}), e.upcastDispatcher.on("element:ol", pm, {priority: "high"}), e.upcastDispatcher.on("element:li", bm, {priority: "high"}), e.upcastDispatcher.on("element:li", mm), t.model.on("insertContent", km, {priority: "high"}), t.commands.add("numberedList", new Xg(t, "numbered")), t.commands.add("bulletedList", new Xg(t, "bulleted")), t.commands.add("indentList", new nm(t, "forward")), t.commands.add("outdentList", new nm(t, "backward"));
		...
		function xm(t) {
			let e = 1;
			for (const n of t.getChildren()) if ("ul" == n.name || "ol" == n.name) for (const t of n.getChildren()) e += xm(t);
			return e
		}

		var Am = '<svg viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M7 5.75c0 .414.336.75.75.75h9.5a.75.75 0 1 0 0-1.5h-9.5a.75.75 0 0 0-.75.75zM3.5 3v5H2V3.7H1v-1h2.5V3zM.343 17.857l2.59-3.257H2.92a.6.6 0 1 0-1.04 0H.302a2 2 0 1 1 3.995 0h-.001c-.048.405-.16.734-.333.988-.175.254-.59.692-1.244 1.312H4.3v1h-4l.043-.043zM7 14.75a.75.75 0 0 1 .75-.75h9.5a.75.75 0 1 1 0 1.5h-9.5a.75.75 0 0 1-.75-.75z"/></svg>',
			Tm = '<svg viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M7 5.75c0 .414.336.75.75.75h9.5a.75.75 0 1 0 0-1.5h-9.5a.75.75 0 0 0-.75.75zm-6 0C1 4.784 1.777 4 2.75 4c.966 0 1.75.777 1.75 1.75 0 .966-.777 1.75-1.75 1.75C1.784 7.5 1 6.723 1 5.75zm6 9c0 .414.336.75.75.75h9.5a.75.75 0 1 0 0-1.5h-9.5a.75.75 0 0 0-.75.75zm-6 0c0-.966.777-1.75 1.75-1.75.966 0 1.75.777 1.75 1.75 0 .966-.777 1.75-1.75 1.75-.966 0-1.75-.777-1.75-1.75z"/></svg>';

		class Cm extends Kl {
			init() {
				const t = this.editor.t;
				cm(this.editor, "numberedList", t("ap"), Am), cm(this.editor, "bulletedList", t("aq"), Tm)
			}
		}
		...
		function Sm(t, e, n, i) {
			...
			return o.getFillerOffset = Im, t.insert(t.createPositionAt(o, 0), e.getMediaViewElement(t, n, i)), o
		}
		...
		class Nm extends ed {
			...
			execute(t) {
				const e = this.editor.model, n = e.document.selection, i = Mm(n);
				if (i) e.change(e => {
		...
		class Dm {
			...
			_getMedia(t) {
				if (!t) return new Lm(this.locale);
				t = t.trim();
				for (const e of this.providerDefinitions) {
					...
					for (const e of i) {
						...
						if (i) return new Lm(this.locale, t, i, n)
					}
				}
				return null
			}
		...
		class Lm {
			...
			_getPlaceholderHtml() {
				...
				return t.text = this._t("Open media in new tab"), e.content = Om, e.viewBox = Rm, new bl({
					tag: "div",
		...
		class jm extends Kl {
			...
			constructor(t) {
				...
				}), this.registry = new Dm(t.locale, t.config.get("mediaEmbed"))
			}

			init() {
				const t = this.editor, e = t.model.schema, n = t.t, i = t.conversion,
					o = t.config.get("mediaEmbed.previewsInData"), r = this.registry;
				t.commands.add("mediaEmbed", new Nm(t)), e.register("media", {
					isObject: !0,
					isBlock: !0,
					allowWhere: "$block",
					allowAttributes: ["url"]
					...
					model: "media", view: (t, e) => {
						...
						return Sm(e, r, n, {renderMediaPreview: n && o})
					}
				}), i.for("dataDowncast").add(Pm(r, {renderMediaPreview: o})), i.for("editingDowncast").elementToElement({
					model: "media",
					view: (t, e) => {
						const i = t.getAttribute("url");
						return function (t, e, n) {
							return e.setCustomProperty("media", !0, t), Xh(t, e, {label: n})
						}(Sm(e, r, i, {renderForEditingView: !0}), e, n("q"))
					}
				}), i.for("editingDowncast").add(Pm(r, {renderForEditingView: !0})), i.for("upcast").elementToElement({
					view: {
						name: "oembed",
						attributes: {url: !0}
					}, model: (t, e) => {
		...
		class zm extends Kl {
			...
			_embedMediaBetweenPositions(t, e) {
				const n = this.editor, i = n.plugins.get(jm).registry, o = new oa(t, e),
					r = o.getWalker({ignoreElementEnd: !0});
				let s = "";
				for (const t of r) t.item.is("textProxy") && (s += t.item.data);
				if (!(s = s.trim()).match(Vm)) return;
				...
				n.commands.get("mediaEmbed").isEnabled && (this._positionToInsert = Dc.fromPosition(t), this._timeoutId = nr.window.setTimeout(() => {
					n.model.change(t => {
						let e;
						this._timeoutId = null, t.remove(o), "$graveyard" !== this._positionToInsert.root.rootName && (e = this._positionToInsert), Em(n.model, s, e), this._positionToInsert.detach(), this._positionToInsert = null
					})
				}, 100))
			}
		}
		...
		class Bm extends Dl {
			...
			_createUrlInput() {
				...
				return this._urlInputViewInfoDefault = t("ce"), this._urlInputViewInfoTip = t("cf"), e.label = t("cg"), e.infoText = this._urlInputViewInfoDefault, n.placeholder = "https://example.com", n.on("input", () => {
		...
		class Um extends Kl {
			...
			init() {
				const t = this.editor, e = t.commands.get("mediaEmbed"), n = t.plugins.get(jm).registry;
				this.form = new Bm(function (t, e) {
					return [e => {
						if (!e.url.length) return t("t")
					}, n => {
						if (!e.hasMedia(n.url)) return t("u")
					}]
		...
		const Ym = /id=("|')docs-internal-guid-[-0-9a-f]+("|')/i;
			...
			execute(t) {
				...
				!function (t, e) {
					...
					for (const n of e.createRangeIn(t)) {
						...
						if (t.is("li")) {
							const n = t.nextSibling;
							n && Wm(n) && (e.remove(n), e.insertChild(t.childCount, n, t))
						}
						if (Wm(t)) {
							let n = t.getChild(0);
							for (; Wm(n);) e.unwrapElement(n), n = t.getChild(0)
						}
					}
				}(t.content, e), function (t, e) {
					for (const n of e.createRangeIn(t)) {
		...
		function Km(t, e) {
			...
			i.length && function (t, e, n) {
				if (t.length === e.length) for (let i = 0; i < t.length; i++) {
					const o = `data:${e[i].type};base64,${Jm(e[i].hex)}`;
		...
		const Zm = /<meta\s*name="?generator"?\s*content="?microsoft\s*word\s*\d+"?\/?>/i,
			Xm = /xmlns:o="urn:schemas-microsoft-com/i;

		class tp {
			isActive(t) {
				return Zm.test(t) || Xm.test(t)
			}

			execute(t) {
				const {body: e, stylesString: n} = Qm(t.dataTransfer.getData("text/html"));
				Hm(e, n), Km(e, t.dataTransfer.getData("text/rtf")), t.content = e
			}
		}
		...
		class sb extends Kl {
			init() {
				...
				t.ui.componentFactory.add("insertTable", n => {
					...
					o.bind("isEnabled").to(i), o.buttonView.set({icon: nb, label: e("x"), tooltip: !0});
					const r = new tb(n);
					...
					const n = [{
						type: "switchbutton",
						model: {commandName: "setTableColumnHeader", label: e("y"), bindIsOn: !0}
					}, {type: "separator"}, {
						type: "button",
						model: {commandName: "insertTableColumnLeft", label: e("z")}
					}, {
						type: "button",
						model: {commandName: "insertTableColumnRight", label: e("aa")}
					}, {type: "button", model: {commandName: "removeTableColumn", label: e("ab")}}];
					return this._prepareDropdown(e("ac"), ib, n, t)
				}), t.ui.componentFactory.add("tableRow", t => {
					const n = [{
						type: "switchbutton",
						model: {commandName: "setTableRowHeader", label: e("ad"), bindIsOn: !0}
					}, {type: "separator"}, {
						type: "button",
						model: {commandName: "insertTableRowBelow", label: e("ae")}
					}, {type: "button", model: {commandName: "insertTableRowAbove", label: e("af")}}, {
						type: "button",
						model: {commandName: "removeTableRow", label: e("ag")}
					}];
					return this._prepareDropdown(e("ah"), ob, n, t)
				}), t.ui.componentFactory.add("mergeTableCells", t => {
					const n = [{
						type: "button",
						model: {commandName: "mergeTableCellUp", label: e("ai")}
					}, {type: "button", model: {commandName: "mergeTableCellRight", label: e("aj")}}, {
						type: "button",
						model: {commandName: "mergeTableCellDown", label: e("ak")}
					}, {
						type: "button",
						model: {commandName: "mergeTableCellLeft", label: e("al")}
					}, {type: "separator"}, {
						type: "button",
						model: {commandName: "splitTableCellVertically", label: e("am")}
					}, {type: "button", model: {commandName: "splitTableCellHorizontally", label: e("an")}}];
					return this._prepareDropdown(e("ao"), rb, n, t)
				})
			}
		...
		class ub extends ed {
			refresh() {
				const t = this.editor.locale, e = vh(this.editor.model.document.selection.getSelectedBlocks());
			...
			execute(t = {}) {
				...
				i.change(t => {
					...
					db(r, n) || i === r || !r ? function (t, e) {
						for (const n of t) e.removeAttribute(hb, n)
					}(e, t) : function (t, e, n) {
						for (const i of t) e.setAttribute(hb, n, i)
					}(e, t, r)
				})
			}

			_canBeAligned(t) {
				return this.editor.model.schema.checkAttribute(t, hb)
			}
		}
		...
		class fb extends Kl {
			...
			init() {
				...
				t.conversion.attributeToAttribute(o), t.commands.add("alignment", new ub(t))
			}
		}

		var gb = '<svg viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M2 3.75c0 .414.336.75.75.75h14.5a.75.75 0 1 0 0-1.5H2.75a.75.75 0 0 0-.75.75zm0 8c0 .414.336.75.75.75h14.5a.75.75 0 1 0 0-1.5H2.75a.75.75 0 0 0-.75.75zm0 4c0 .414.336.75.75.75h9.929a.75.75 0 1 0 0-1.5H2.75a.75.75 0 0 0-.75.75zm0-8c0 .414.336.75.75.75h9.929a.75.75 0 1 0 0-1.5H2.75a.75.75 0 0 0-.75.75z"/></svg>',
			mb = '<svg viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M18 3.75a.75.75 0 0 1-.75.75H2.75a.75.75 0 1 1 0-1.5h14.5a.75.75 0 0 1 .75.75zm0 8a.75.75 0 0 1-.75.75H2.75a.75.75 0 1 1 0-1.5h14.5a.75.75 0 0 1 .75.75zm0 4a.75.75 0 0 1-.75.75H7.321a.75.75 0 1 1 0-1.5h9.929a.75.75 0 0 1 .75.75zm0-8a.75.75 0 0 1-.75.75H7.321a.75.75 0 1 1 0-1.5h9.929a.75.75 0 0 1 .75.75z"/></svg>';
		const pb = new Map([["left", gb], ["right", mb], ["center", '<svg viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M2 3.75c0 .414.336.75.75.75h14.5a.75.75 0 1 0 0-1.5H2.75a.75.75 0 0 0-.75.75zm0 8c0 .414.336.75.75.75h14.5a.75.75 0 1 0 0-1.5H2.75a.75.75 0 0 0-.75.75zm2.286 4c0 .414.336.75.75.75h9.928a.75.75 0 1 0 0-1.5H5.036a.75.75 0 0 0-.75.75zm0-8c0 .414.336.75.75.75h9.928a.75.75 0 1 0 0-1.5H5.036a.75.75 0 0 0-.75.75z"/></svg>'], ["justify", '<svg viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M2 3.75c0 .414.336.75.75.75h14.5a.75.75 0 1 0 0-1.5H2.75a.75.75 0 0 0-.75.75zm0 8c0 .414.336.75.75.75h14.5a.75.75 0 1 0 0-1.5H2.75a.75.75 0 0 0-.75.75zm0 4c0 .414.336.75.75.75h9.929a.75.75 0 1 0 0-1.5H2.75a.75.75 0 0 0-.75.75zm0-8c0 .414.336.75.75.75h14.5a.75.75 0 1 0 0-1.5H2.75a.75.75 0 0 0-.75.75z"/></svg>']]);
		...
		class bb extends Kl {
			...
			init() {
				...
				i.filter(lb).forEach(t => this._addButton(t)), e.add("alignment", t => {
					const o = Sf(t), r = i.map(t => e.create(`alignment:${t}`));
					!function (t, e) {
						const n = t.locale, i = n.t, o = t.toolbarView = new $l(n);
					...
					}(o, r), o.buttonView.set({
						label: n("av"),
						tooltip: !0
					}), o.toolbarView.isVertical = !0, o.toolbarView.ariaLabel = n("aw"), o.extendTemplate({attributes: {class: "ck-alignment-dropdown"}});
					const s = "rtl" === t.contentLanguageDirection ? mb : gb;
			...
			_addButton(t) {
				...
				e.ui.componentFactory.add(`alignment:${t}`, n => {
					const i = e.commands.get("alignment"), o = new Wd(n);
					return o.set({
		...
		wb.builtinPlugins = [class extends Kl {
			static get requires() {
			...
			init() {
				...
				e.push(new tp), e.push(new $m), t.plugins.get("Clipboard").on("inputTransformation", (t, n) => {
			...
			toolbar: {items: ["heading", "|", "alignment", "bold", "italic", "link", "bulletedList", "numberedList", "imageUpload", "blockQuote", "insertTable", "mediaEmbed", "undo", "redo"]},
